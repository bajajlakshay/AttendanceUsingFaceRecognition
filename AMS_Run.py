    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'Attendance/ManuallyAttendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"/Attendance/ManuallyAttendance/"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('/home/lakshay/AttendanceUsingFace/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv("/home/lakshay/AttendanceUsingFace/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='grey80')
                cs = '/home/lakshay/AttendanceUsingFace/' + fileName
    ...
    def Attf():
        ...
        fileName = "Attendance/" + Subject + "_" + date + \
        "_" + Hour + "-" + Minute + ".csv"
        subprocess.Popen(['xdg-open', '/home/lakshay/AttendanceUsingFace/Attendance/' + fileName])
    ...
    def log_in():
        ...
        if username == 'lakshay':
            if password == 'lakshay123':
                ...
                cs = '/home/lakshay/AttendanceUsingFace/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
